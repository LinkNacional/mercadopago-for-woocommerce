...
<div>
    ...
    <div class="mp-col-md-12 mp_tienda_link">
        <p class="">
            <a href=<?php echo esc_html( $link_url_one ); ?>
                target="_blank"><?php echo esc_html( $button_about_pix ); ?></a>
        </p>
    </div>
    ...
    <div class="mp-col-md-12 mp-pb-10">
        <p class="mp-text-observation mp-gray-text">
            ...
            <a href=<?php echo esc_html( $link_url_two ); ?>
                target="_blank"><?php echo esc_html( $link_title_one ); ?></a>
        </p>
    </div>
