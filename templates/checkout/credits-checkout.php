    ...
    <div class="mp-checkout-pro-container">
        <div class="mp-checkout-pro-content">
            ...
            <div class="mp-checkout-pro-test-mode">
                <test-mode
                    title="<?php echo esc_html_e('No card installments in Test Mode', LKN_WC_MERCADOPAGO_TEXT_DOMAIN); ?>"
            ...
            <checkout-benefits
                title="<?php echo esc_html_e('How to use it?', LKN_WC_MERCADOPAGO_TEXT_DOMAIN); ?>"
                title-align="left" items='[
					"<?php echo esc_html_e('<b>Log in</b> or create an account in Mercado Pago. If you use Mercado Libre, you already have one!', LKN_WC_MERCADOPAGO_TEXT_DOMAIN); ?>",
					"<?php echo esc_html_e('Know your available limit in Mercado Crédito and <b>choose how many installments</b> you want to pay.', LKN_WC_MERCADOPAGO_TEXT_DOMAIN); ?>",
					"<?php echo esc_html_e('Pay the installments as you prefer: <b>with money in your account, card of from the Mercado Pago app.</b>', LKN_WC_MERCADOPAGO_TEXT_DOMAIN); ?>"
				]' list-mode='count'>
            </checkout-benefits>
            <div class="mp-checkout-pro-redirect">
                <checkout-redirect-v2
                    text="<?php echo esc_html_e('By confirming your purchase, you will be redirected to your Mercado Pago account.', LKN_WC_MERCADOPAGO_TEXT_DOMAIN); ?>"
