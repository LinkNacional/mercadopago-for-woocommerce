...
<p>
<p>
    <?php echo esc_html__( 'Great, we processed your purchase order. Complete the payment with ticket so that we finish approving it.', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ); ?>
</p>
...
<a id="submit-payment" target="_blank"
    ...
    <?php echo esc_html__( 'Print ticket', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ); ?>
</a>
</p>