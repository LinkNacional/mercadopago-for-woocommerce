...
<div class="mp-details-pix">
    <div class="mp-row-checkout-pix">
        ...
        <div class="mp-col-md-4">
            ...
            <img src="<?php echo esc_html( $img_pix ); ?>"
                class="mp-details-pix-img" />
        ...
        <div class="mp-col-md-8 mp-text-center mp-pix-right">
            ...
            <img data-cy="qrcode-pix" class="mp-details-pix-qr-img"
                src="data:image/jpeg;base64,<?php echo esc_html( $qr_base64 ); ?>" />
            ...
            <div class="mp-details-pix-container">
                ...
                <div class="mp-row-checkout-pix-container">
                    <input id="mp-qr-code"
                        ...
                        class="mp-qr-input"></input>
                    <button onclick="copy_qr_code()" class="mp-details-pix-button"
                        onclick="true"><?php echo esc_html( $text_button ); ?></button>
                    <script>
