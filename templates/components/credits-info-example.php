...
<div class="credits-info-example-container">
    <div class="credits-info-example-buttons-container">
        <div class="credits-info-example-buttons-child credits-info-button-selected">
            ...
            <div class="credits-info-example-buttons-content">
                <div>
                    <img class="icon-image" alt="computer"
                        src="<?php echo esc_html(plugins_url('../assets/images/credits/desktop-gray-icon.png', plugin_dir_path(__FILE__))); ?>">
                </div>
                <div>
        ...
        <div class="credits-info-example-buttons-child">
            ...
            <div class="credits-info-example-buttons-content">
                <div>
                    <img class="icon-image" alt="cellphone"
                        src="<?php echo esc_html(plugins_url('../assets/images/credits/cellphone-gray-icon.png', plugin_dir_path(__FILE__))); ?>">
                </div>

                <div>
                    <p><?php echo esc_html( $settings['value']['cellphone'] ); ?>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="credits-info-example-gif-container">
        <div class="credits-info-example-gif">
            <img id="gif-image" alt='example'
                src="<?php echo esc_html(plugins_url('../assets/images/credits/view_desktop.gif', plugin_dir_path(__FILE__))); ?>">
        </div>
