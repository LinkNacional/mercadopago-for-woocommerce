 ...
 */
class WC_WooMercadoPago_Saved_Cards {
    public const SAVED_CARDS_NONCE_ID = 'mp_saved_cards_nonce';
     ...
     * @return void
     */
    public function load_saved_cards_notice_css(): void {
        if ( is_admin() ) {
            wp_enqueue_style(
     ...
     * @return void
     */
    public function load_saved_cards_notice_js(): void {
        if ( is_admin() ) {
     ...
     */
    public function saved_cards_notice_dismiss(): void {
