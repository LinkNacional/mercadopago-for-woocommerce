...
class WC_WooMercadoPago_Image_Generator {
     ...
     * Get qr code image
     */
    public function get_image_qr(): void {
        ...
        $pix_qr_image = base64_decode($pix_base64, true);
     ...
     * Get Error Image
     */
    public static function get_error_image(): void {
        header('Content-type: image/png');
        $png_image = __DIR__ . '/../../assets/images/pix_has_expired.png';
