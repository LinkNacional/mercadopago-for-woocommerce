...
class WC_WooMercadoPago_Payment_Abstract extends WC_Payment_Gateway {
     ...
     * @const
     */
    public const COMMON_CONFIGS = array(
        '_mp_public_key_test',
    ...
    public function mercadopago_after_form(): void {
        wc_get_template(
     ...
     */
    public function normalize_common_admin_fields(): void {
    ...
    public function validate_section() {
        if (
			...
			) && ! in_array( $_GET['section'], self::ALLOWED_CLASSES, true )
        ) {
            return false;
        }
     ...
     * @return void
     */
    private function load_custom_js_for_checkbox(): void {
     ...
     * @return void
     */
    private function load_custom_credentials_js(): void {
     ...
     * Disable Payments MP
     */
    public function disable_all_payments_methods_mp(): void {
     ...
     * @param $order
     */
    public function set_order_to_pending_on_retry( $order ): void {
