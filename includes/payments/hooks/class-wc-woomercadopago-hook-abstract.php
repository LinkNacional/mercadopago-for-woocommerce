...
abstract class WC_WooMercadoPago_Hook_Abstract {
     ...
     */
    public function add_discount_abst( $checkout ): void {
        if (
     ...
     * MP Settings Script
     */
    public function add_mp_settings_script(): void {
     ...
     * @return void
     */
    public function update_mp_settings_script( $order_id ): void {
        // Do nothing
    }
     ...
     * @return void
     */
    public function update_mp_order_payments_metadata( $order_id, $payments_id ): void {
