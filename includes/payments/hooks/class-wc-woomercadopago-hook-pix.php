...
class WC_WooMercadoPago_Hook_Pix extends WC_WooMercadoPago_Hook_Abstract {
    ...
    public function update_mp_settings_script_pix( $order_id ): void {
        ...
        $parameters = array(
            ...
            'qr_base64' => $qr_base64,
            'title_purchase_pix' => __( 'Now you just need to pay with Pix to finalize your purchase', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
            'title_how_to_pay' => __( 'How to pay with Pix:', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
            'step_one' => __( 'Go to your bank\'s app or website', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
            'step_two' => __( 'Search for the option to pay with Pix', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
            'step_three' => __( 'Scan the QR code or Pix code', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
            'step_four' => __( 'Done! You will see the payment confirmation', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
            'text_amount' => __( 'Value: ', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
            'currency' => $currency_symbol[ strtolower(get_option( '_site_id_v1' )) ]['currency_symbol'],
            'text_scan_qr' => __( 'Scan the QR code:', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
            'text_time_qr_one' => __( 'Code valid for ', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
            'qr_date_expiration' => __($this->payment->get_option_mp( 'checkout_pix_date_expiration', '30 minutes' ), LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
            'text_description_qr' => __( 'If you prefer, you can pay by copying and pasting the following code', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
            'qr_code' => $qr_code,
            'text_button' => __( 'Copy code', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
        );
