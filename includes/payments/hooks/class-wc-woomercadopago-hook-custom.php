        ...
        if ( is_checkout() && $this->payment->is_available() && ! get_query_var( 'order-received' ) ) {
            ...
            wp_localize_script(
                ...
                array(
                    ...
                    'rate_text' => __( 'No fee', WC_MERCADOPAGO_TEXT_DOMAIN ),
                    'more_installments_text' => __( 'More options', WC_MERCADOPAGO_TEXT_DOMAIN ),
                    ...
                    'placeholders' => array(
                        'cardExpirationDate' => __( 'mm/yy', WC_MERCADOPAGO_TEXT_DOMAIN ),
                        'issuer' => __( 'Issuer', WC_MERCADOPAGO_TEXT_DOMAIN ),
                        'installments' => __( 'Installments', WC_MERCADOPAGO_TEXT_DOMAIN ),
                    ),
                    'cvvHint' => array(
                        'back' => __( 'on the back', WC_MERCADOPAGO_TEXT_DOMAIN ),
                        'front' => __( 'on the front', WC_MERCADOPAGO_TEXT_DOMAIN ),
                    ),
                    'cvvText' => __( 'digits', WC_MERCADOPAGO_TEXT_DOMAIN ),
                    'installmentObsFee' => __( 'No fee', WC_MERCADOPAGO_TEXT_DOMAIN ),
                    'installmentButton' => __( 'More options', WC_MERCADOPAGO_TEXT_DOMAIN ),
                    'bankInterestText' => __( 'If interest is applicable, it will be charged by your bank.', WC_MERCADOPAGO_TEXT_DOMAIN ),
                    'interestText' => __( 'Interest', WC_MERCADOPAGO_TEXT_DOMAIN ),
                    'input_helper_message' => array(
                        'cardNumber' => array(
                            'invalid_type' => __( 'Card number is required', WC_MERCADOPAGO_TEXT_DOMAIN ),
                            'invalid_length' => __( 'Card number invalid', WC_MERCADOPAGO_TEXT_DOMAIN ),
                        ),
                        'cardholderName' => array(
                            '221' => __( 'Holder name is required', WC_MERCADOPAGO_TEXT_DOMAIN ),
                            '316' => __( 'Holder name invalid', WC_MERCADOPAGO_TEXT_DOMAIN ),
                        ),
                        'expirationDate' => array(
                            'invalid_type' => __( 'Expiration date invalid', WC_MERCADOPAGO_TEXT_DOMAIN ),
                            'invalid_length' => __( 'Expiration date incomplete', WC_MERCADOPAGO_TEXT_DOMAIN ),
                            'invalid_value' => __( 'Expiration date invalid', WC_MERCADOPAGO_TEXT_DOMAIN ),
                        ),
                        'securityCode' => array(
                            'invalid_type' => __( 'Security code is required', WC_MERCADOPAGO_TEXT_DOMAIN ),
                            'invalid_length' => __( 'Security code incomplete', WC_MERCADOPAGO_TEXT_DOMAIN ),
                        )
                    ),
    ...
    public function update_mp_settings_script_custom( $order_id ): void {
        ...
        if ( $total_diff_cost > 0 ) {
            $parameters_custom = array(
                'title_installment_cost' => __( 'Cost of installments', WC_MERCADOPAGO_TEXT_DOMAIN ),
                'title_installment_total' => __( 'Total with installments', WC_MERCADOPAGO_TEXT_DOMAIN ),
                'text_installments' => __( 'installments of', WC_MERCADOPAGO_TEXT_DOMAIN ),
