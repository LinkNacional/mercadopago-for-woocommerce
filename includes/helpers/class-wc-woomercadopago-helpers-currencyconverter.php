 ...
 */
class WC_WooMercadoPago_Helpers_CurrencyConverter {
    public const CONFIG_KEY = 'currency_conversion';

    public const DEFAULT_RATIO = 1;
     ...
     */
    private function set_ratio( $method_id, $value = self::DEFAULT_RATIO ): void {
     ...
     */
    public function schedule_notice( WC_WooMercadoPago_Payment_Abstract $method, $old_data, $new_data ): void {
     ...
     * @param WC_WooMercadoPago_Payment_Abstract $method method.
     */
    public function notices( WC_WooMercadoPago_Payment_Abstract $method ): void {
     ...
     * @param WC_WooMercadoPago_Payment_Abstract $method method.
     */
    public function notice_enabled( WC_WooMercadoPago_Payment_Abstract $method ): void {
        $local_currency = get_woocommerce_currency();
     ...
     * @param WC_WooMercadoPago_Payment_Abstract $method method.
     */
    public function notice_disabled( WC_WooMercadoPago_Payment_Abstract $method ): void {
        $local_currency = get_woocommerce_currency();
        $currency = $this->get_account_currency( $method );
        $type = 'notice-error';
        $message = sprintf(
     ...
     * @param WC_WooMercadoPago_Payment_Abstract $method method.
     */
    public function notice_warning( WC_WooMercadoPago_Payment_Abstract $method ): void {
