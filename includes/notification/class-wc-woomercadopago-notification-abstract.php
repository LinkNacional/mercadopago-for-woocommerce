...
abstract class WC_WooMercadoPago_Notification_Abstract {
     ...
     */
    public function process_status( $processed_status, $data, $order ): void {
     ...
     */
    public function process_cancel_order_meta_box_actions( $order ): void {
     ...
     */
    public function set_response( $code, $code_message, $body ): void {
        status_header( $code, $code_message );
        die ( wp_kses_post ($body ));
    }

    public function update_meta( $order, $key, $value ): void {
