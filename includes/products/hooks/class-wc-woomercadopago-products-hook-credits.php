...
class WC_WooMercadoPago_Products_Hook_Credits {
    ...
    public function before_add_to_cart_form(): void {
        ...
        wc_get_template(
            ...
            array (
                'banner_title' => __( 'Pay in', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
                'banner_title_bold' => __('installments', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
                'banner_title_end' => __('with Mercado Pago', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
                'banner_link' => __( 'Read more', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
                'modal_title' => __( 'Buy now and pay in installments with no card later!', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
                'modal_subtitle' => __( '100% online,', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
                'modal_subtitle_2' => __( 'without paperwork or monthly fees', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
                'modal_step_1' => __( 'When paying, choose', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
                'modal_step_1_end' => __('. Login to your account or create one in a few steps.', LKN_WC_MERCADOPAGO_TEXT_DOMAIN),
                'modal_step_2' => __( 'Search for', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
                'modal_step_2_end' => __('among the options, select it and choose in how many installments you would like to pay.', LKN_WC_MERCADOPAGO_TEXT_DOMAIN),
                'modal_step_3' => __( 'Pay your installments monthly as you wish, in the Mercado Pago app.', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
                'modal_footer' => __( 'Questions? ', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
                'modal_footer_help_link' => $links['FAQ_link'],
                'modal_footer_link' => __('Check our FAQ', LKN_WC_MERCADOPAGO_TEXT_DOMAIN),
                'modal_footer_end' => __('. Credit subject to approval.', LKN_WC_MERCADOPAGO_TEXT_DOMAIN)
            ),
            '',
