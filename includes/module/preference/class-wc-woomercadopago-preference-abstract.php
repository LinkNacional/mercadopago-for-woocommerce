...
abstract class WC_WooMercadoPago_Preference_Abstract extends WC_Payment_Gateway {
    ...
    public function __construct( $payment, $order, $request_checkout = null ) {
        ...
        try {
            ...
            throw new Exception( __( 'This payment method cannot process your payment.', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ) );
        }
     ...
     */
    public function make_common_transaction(): void {
    ...
    public function ship_cost_item() {
        ...
        return array(
            ...
            'description' => __( 'Shipping service used by the store.', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
            'category_id' => get_option( '_mp_category_id', 'others' ),
            'quantity' => 1,
     ...
     *
     * @param WC_WooMercadoPago_Payment_Abstract|null $payment Payment.
     * @return string
     */
    ...
    public function add_discounts() {
        return array(
            'title' => __( 'Discount provided by store', LKN_WC_MERCADOPAGO_TEXT_DOMAIN ),
    ...
    public function get_internal_metadata() {
        ...
        return array(
            ...
            'billing_address' => array(
                'zip_code' => html_entity_decode(
                    str_replace('-', '', ( is_object($this->order) &&
