...
class WC_WooMercadoPago_Credentials {
    ...
    public const TYPE_ACCESS_TOKEN = 'token';
     ...
     */
    public static function mercadopago_payment_update(): void {
        try {
     ...
     * @return void
     */
    public static function set_no_credentials(): void {
     ...
     */
    public static function update_payment_methods( $mp_instance, $access_token = null, $payments_response = null ): void {
     ...
     * @return void
     */
    public static function update_pix_method( $mp_instance, $access_token, $payments_response = null ): void {
        if ( empty( $access_token ) || empty( $mp_instance ) ) {
            return;
        }
     ...
     * @return void
     */
    public static function update_ticket_method( $mp_instance, $access_token, $payments_response = null ): void {
        if ( empty( $access_token ) || empty( $mp_instance ) ) {
            return;
        }
