...
class WC_WooMercadoPago_Options {
    public const CREDENTIALS_PUBLIC_KEY_PROD = '_mp_public_key_prod';

    public const CREDENTIALS_PUBLIC_KEY_TEST = '_mp_public_key_test';

    public const CREDENTIALS_ACCESS_TOKEN_PROD = '_mp_access_token_prod';

    public const CREDENTIALS_ACCESS_TOKEN_TEST = '_mp_access_token_test';

    public const CHECKOUT_COUNTRY = 'checkout_country';

    public const STORE_ID = '_mp_store_identificator';

    public const STORE_NAME = 'mp_statement_descriptor';

    public const STORE_CATEGORY = '_mp_category_id';

    public const INTEGRATOR_ID = '_mp_integrator_id';

    public const DEBUG_MODE = '_mp_debug_mode';

    public const CUSTOM_DOMAIN = '_mp_custom_domain';

    public const CUSTOM_DOMAIN_OPTIONS = '_mp_custom_domain_options';

    public const CHECKBOX_CHECKOUT_TEST_MODE = 'checkbox_checkout_test_mode';

    public const CHECKBOX_CHECKOUT_PRODUCTION_MODE = 'checkbox_checkout_production_mode';

    public const WOOCOMMERCE_COUNTRY = 'woocommerce_default_country';

    public const HOMOLOG_VALIDATE = 'homolog_validate';

    public const APPLICATION_ID = 'mp_application_id';

    public const SITE_ID = '_site_id_v1';

    public const CLIENT_ID = '_mp_client_id';
